...
import { TERMS_OF_SERVICE } from "@/lib/marketing/legal-content";

export const metadata: Metadata = {
  title: "Kullanım Şartları | DerecePanel",
  description: "DerecePanel kullanım şartları ve hizmet koşulları.",
};
  ...
  return (
    <div className="min-h-screen bg-[#F4F7F6] font-sans">
      ...
      <main className="mx-auto max-w-3xl px-6 py-14">
        ...
        <p className="mb-10 text-slate-500 leading-relaxed">{TERMS_OF_SERVICE.intro}</p>
        ...
        <p className="mt-8 text-sm text-slate-500">
          ...
          <Link href="/gizlilik" className="font-medium text-orange-600 hover:text-orange-700">
            Gizlilik Politikası
          </Link>
          sayfasına bakın.
        </p>
        <p className="mt-4 text-xs text-slate-400">Son güncelleme: {TERMS_OF_SERVICE.updated}</p>
      </main>
    </div>
  );
}
